(ns rf-query.use-subscribe
  "From https://github.com/pitch-io/uix/blob/master/docs/interop-with-reagent.md"
...
(defn- use-sync-external-store [subscribe get-snapshot]
  (useSyncExternalStoreWithSelector
   subscribe
   get-snapshot
   ;; getServerSnapshot, only needed for SSR
   nil
...
(defn use-reaction
  ...
  [reaction]
  ;; Can't use defhook because conditional use-sync-external-store call
...
(defn use-subscribe
  ...
  [query]
  ;; Can't use defhook because rf/subscribe call
